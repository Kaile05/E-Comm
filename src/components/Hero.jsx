...
function Hero() {
  return (
    <section className='min-h-screen flex justify-center items-start mt-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 mt-5'>
          <div className='bg-white rounded p-3'>
            <div className='p-6'>
              <h1 className='text-3xl md:text-5xl text-center font-bold'>Shop the <span className='text-gray-500'>Future</span>, Today!</h1>
              <img src={man} className='h-full w-full object-cover hover:drop-shadow-2xl transition' alt='man'/>
            </div>
          </div>
          <div className='bg-gray-500 p-3'> 
            <div className='p-6 border-r-4 border-t-6 border-white'>
